...
const UpdatedUserData = {
  ...
  return (
    <form onSubmit={(e) => {
    ...
    } className='h-[70vh] w-full flex flex-col px-7 sm:flex-row'>
      <div className='h-full w-[48%] text-white px-5 py-3'>
        ...
        <input
          ...
          placeholder='Make Production Report etc....' className='outline-none text-white h-12 p-2 border-2 w-[70vw] mt-5 font-semibold rounded-md sm:w-[38vw]' type="text" />
        ...
        <input
          ...
          placeholder='Date of Task' className='outline-none h-12 p-2 border-2 w-[70vw] mt-5 font-semibold rounded-md sm:w-[38vw]' type="Date" />
        <h2 className='text-xl font-bold mt-8'>Assign To :</h2>
        <input
          value={asignTo} onChange={(e) => {
            setAsignTo(e.target.value);
          }}
          placeholder='Task Assigned to whom' className='outline-none h-12 p-2 border-2 w-[70vw] mt-5 font-semibold rounded-md sm:w-[38vw]' type="text" />
        <h2 className='text-xl font-bold mt-8'>Category :</h2>
        <input
          value={category} onChange={(e) => {
            setCategory(e.target.value);
          }}
          placeholder='To which catagory belongs' className='h-12 px-2 outline-none border-2 w-[70vw] mt-5 font-semibold rounded-md sm:w-[38vw]' type="text" />
      </div>
      <div className='h-full w-[48%] flex flex-col mt-15 text-white'>

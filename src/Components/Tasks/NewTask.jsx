...
function NewTask() {
  return (
      <div className="flex-shrink-0 h-full w-[310px] bg-emerald-500 rounded-2xl ">
        ...
        <div className=" px-6">
          ...
          <button className='flex justify-center bg-green-700 font-semibold  px-2 py-1 rounded-md  text-[13px]  text-white '> Accept Task </button>
          </div>
        </div>
      </div>
  )

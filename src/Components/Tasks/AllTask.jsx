...
function AllTask() {
    ...
    return (
        <div className='bg-[#1c1c1c] h-[80%] py-8 mr-5' >
          <div className='h-[7vh] mt-20 flex justify-center w-full bg-[#1c1c1c] px-7   '>
                <div className='h-[7vh] w-[97%] rounded-md border-2 border-white flex bg-emerald-600 text-white justify-between items-center gap-1 px-14 py-3 ml-3'>
            ...
            <div className='bg-[#1c1c1c]  p-5 rounded-mg h-48 '>
                {userData.employeeData.map((elem, idx) => {
                        return (
                         ...
                         mb-2 px-5 py-3 flex justify-around ml-10 items-center w-[95%] rounded-md'>
